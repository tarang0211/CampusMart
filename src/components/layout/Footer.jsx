...
import { Building2, ShieldCheck, Heart, Mail, Phone, MapPin, Sparkles } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li>
                <Link to="/sell" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Sell an Item
                </Link>
              </li>
              <li>
                <Link to="/wishlist" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  My Saved Wishlist
                </Link>
              </li>
              <li>
                <Link to="/my-listings" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Manage My Listings
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li><span className="hover:text-blue-600 cursor-pointer">Engineering Textbooks</span></li>
              <li><span className="hover:text-blue-600 cursor-pointer">Calculators & Gadgets</span></li>
              <li><span className="hover:text-blue-600 cursor-pointer">Campus Bicycles</span></li>
              <li><span className="hover:text-blue-600 cursor-pointer">Hostel Kettles & Lamps</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li><a href="#about" className="hover:text-blue-600 dark:hover:text-blue-400">About CampusMart</a></li>
              <li><a href="#contact" className="hover:text-blue-600 dark:hover:text-blue-400">Campus Helpdesk</a></li>
              <li><a href="#privacy" className="hover:text-blue-600 dark:hover:text-blue-400">Privacy Policy</a></li>
              <li><a href="#terms" className="hover:text-blue-600 dark:hover:text-blue-400">Hostel Trade Guidelines</a></li>
            </ul>
          </div>
